...
Хорошо. Тогда редактирую **весь кусок целиком**, который ты прислал: без идеологии, с современнее языком, но **без лишних сокращений и без выбрасывания хода мысли**. Я сохраню структуру, порядок аргументов и объём максимально близко к исходнику. 
